import styles from "./FooterFreelancers.module.scss";
        ...
        <footer className={styles.Footer}>
            <div className={styles.FooterContent}>
                <div className={styles.FooterContent__logotipo}>
                    ...
                    <span>Conectando talento global con<br />
                ...
                <div className={styles.FooterContent__links}>
                    <div className={styles.links__internalLinks}>
                        ...
                        <a
                            href="#GarantiaImpulzzeFreelancers"
                            onClick={(e) => {
                                e.preventDefault();
                                scrollToSection("GarantiaImpulzzeFreelancers");
                            }}
                            className={styles.link}
                        >
                            Compromiso Impulzze
                        ...
                        <a
                            href="#CompromisoImpulzzeFreelancers"
                            onClick={(e) => {
                                e.preventDefault();
                                scrollToSection("CompromisoImpulzzeFreelancers");
                            }}
                            className={styles.link}
                        >
                            Sobre Impulzze
            ...
            <div className={styles.FooterContent__termsYmention}>
                ...
                <p>
                    <a href="https://www.danirox.com/" target="_blank">Diseño y Desarrollo por DaniRox</a>
                </p>
            </div>
        </footer>
    );
